  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-3xl">
        <motion.h1 
          className="text-4xl md:text-5xl font-bold text-center mb-8 text-gold-highlight font-serif"
        ...
        <motion.form 
          ...
          className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 shadow-xl space-y-6"
        ...
        >
          ...
          <div>
             ...
             <div className="grid md:grid-cols-2 gap-6">
                <DatePicker
                    ...
                    className="w-full bg-slate-900/50 p-3 border border-slate-700 rounded-md text-white focus:ring-gold-base focus:border-gold-base transition-colors"
              ...
              {eventTypes.map(event => (
                <div key={event}>
                  <input 
                    ...
                    required 
                  />
                  <label htmlFor={event} className={`block text-center p-3 rounded-md cursor-pointer border transition-all ${formData.eventType === event ? 'bg-gold-base border-gold-base text-primary font-bold' : 'bg-slate-900/50 border-slate-700 text-lightest-slate hover:border-slate-500'}`}>
                    {event}
                  </label>
                </div>
              ))}
          ...
          <button 
            type="submit" 
            className="w-full bg-gold-base text-primary font-bold py-3 rounded-lg hover:bg-gold-highlight transition-colors text-lg disabled:bg-gray-400 disabled:cursor-not-allowed"
